...
var NETWORK_DATA = {
  nodes: [
    ...
    { id: "corgnet", name: "Brice Corgnet", url: "https://sites.google.com/site/corgnetb/", affiliation: "EM Strasbourg Business School, University of Strasbourg", group: "direct" },
    ...
    // === SECOND-DEGREE: Corgnet's coauthors ===
    { id: "hernan", name: "Rafael Hernán", url: "", affiliation: "", group: "second" },
    { id: "sayre", name: "George Sayre", url: "", affiliation: "", group: "second" },
    { id: "gaechter", name: "Simon Gächter", url: "https://sites.google.com/site/sgaechter/", affiliation: "University of Nottingham", group: "second" },
    { id: "gomez", name: "Juan Gomez-Minambres", url: "", affiliation: "", group: "second" },
    { id: "desantis", name: "Mauro DeSantis", url: "", affiliation: "", group: "second" },
    { id: "porter_d", name: "Dylan Porter", url: "", affiliation: "", group: "second" },
    { id: "kujal", name: "Peter Kujal", url: "", affiliation: "", group: "second" },
    { id: "cornand", name: "Camille Cornand", url: "", affiliation: "", group: "second" },
    { id: "hanaki", name: "Naoki Hanaki", url: "", affiliation: "", group: "second" },
    { id: "deck", name: "Cheryl Deck", url: "", affiliation: "", group: "second" },
    { id: "kimbrough", name: "Erik Kimbrough", url: "", affiliation: "", group: "second" },
    { id: "gunia", name: "Brian Gunia", url: "", affiliation: "", group: "second" },
    { id: "sutan", name: "Angela Sutan", url: "", affiliation: "", group: "second" },
    { id: "rassenti", name: "Stephen Rassenti", url: "", affiliation: "", group: "second" },
    { id: "espindola", name: "Antonio Espín", url: "", affiliation: "", group: "second" },
    { id: "capraro", name: "Valerio Capraro", url: "", affiliation: "", group: "second" },
    { id: "schniter", name: "Eric Schniter", url: "", affiliation: "", group: "second" },
    { id: "brandts", name: "Jordi Brandts", url: "", affiliation: "", group: "second" },
    { id: "hu_y", name: "Yonghui Hu", url: "", affiliation: "", group: "second" },
    { id: "dreher", name: "Jean-Claude Dreher", url: "", affiliation: "", group: "second" }
  ],
  ...
  links: [
    ...
    // === CORGNET → second-degree ===
    { source: "corgnet", target: "hernan" },
    { source: "corgnet", target: "sayre" },
    { source: "corgnet", target: "gaechter" },
    { source: "corgnet", target: "gomez" },
    { source: "corgnet", target: "desantis" },
    { source: "corgnet", target: "porter_d" },
    { source: "corgnet", target: "kujal" },
    { source: "corgnet", target: "cornand" },
    { source: "corgnet", target: "hanaki" },
    { source: "corgnet", target: "deck" },
    { source: "corgnet", target: "kimbrough" },
    { source: "corgnet", target: "gunia" },
    { source: "corgnet", target: "sutan" },
    { source: "corgnet", target: "rassenti" },
    { source: "corgnet", target: "espindola" },
    { source: "corgnet", target: "capraro" },
    { source: "corgnet", target: "schniter" },
    { source: "corgnet", target: "brandts" },
    { source: "corgnet", target: "hu_y" },
    { source: "corgnet", target: "dreher" },

    // cross-links within Corgnet's network
    { source: "hernan", target: "sayre" },
    { source: "hernan", target: "gaechter" },
    { source: "hernan", target: "gomez" },
    { source: "hernan", target: "rassenti" },
    { source: "hernan", target: "schniter" },
    { source: "hernan", target: "gunia" },
    { source: "hernan", target: "sutan" },
    { source: "hernan", target: "kujal" },
    { source: "hernan", target: "espindola" },
    { source: "hernan", target: "capraro" },
    { source: "desantis", target: "porter_d" },
    { source: "desantis", target: "deck" },
    { source: "desantis", target: "kimbrough" },
    { source: "desantis", target: "kujal" },
    { source: "desantis", target: "hanaki" },
    { source: "desantis", target: "cornand" },
    { source: "kujal", target: "porter_d" },
    { source: "deck", target: "kimbrough" },
    { source: "cornand", target: "hanaki" },
    { source: "gomez", target: "sutan" },
    { source: "gomez", target: "gunia" },
    { source: "gunia", target: "sutan" },
    { source: "espindola", target: "capraro" },
    { source: "brandts", target: "hernan" }
  ]
};
